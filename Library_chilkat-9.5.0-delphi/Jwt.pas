...
function CkJwt_CreateJwtCert(objHandle: HCkJwt; header: PWideChar; payload: PWideChar; cert: HCkCert; outStr: HCkString): wordbool; stdcall;

function CkJwt__createJwtCert(objHandle: HCkJwt; header: PWideChar; payload: PWideChar; cert: HCkCert): PWideChar; stdcall;
...
function CkJwt_CreateJwtCert; external DLLName;
function CkJwt__createJwtCert; external DLLName;
