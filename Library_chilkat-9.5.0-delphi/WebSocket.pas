...
function CkWebSocket_getHeartbeatMs(objHandle: HCkWebSocket): Integer; stdcall;

procedure CkWebSocket_putHeartbeatMs(objHandle: HCkWebSocket; newPropVal: Integer); stdcall;
...
function CkWebSocket_getHeartbeatMs; external DLLName;
procedure CkWebSocket_putHeartbeatMs; external DLLName;
