...
function CkFtp2_GetSize64Async(objHandle: HCkFtp2; index: Integer): HCkTask; stdcall;
...
function CkFtp2_GetSizeByName64Async(objHandle: HCkFtp2; filename: PWideChar): HCkTask; stdcall;
...
function CkFtp2_GetSize64Async; external DLLName;
...
function CkFtp2_GetSizeByName64Async; external DLLName;
