...
function CkSshTunnel_SetAllowedAlgorithms(objHandle: HCkSshTunnel; json: HCkJsonObject): wordbool; stdcall;
...
function CkSshTunnel_SetAllowedAlgorithms; external DLLName;
