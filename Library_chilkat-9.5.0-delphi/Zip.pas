...
function CkZip_ExtractIntoAsync(objHandle: HCkZip; dirPath: PWideChar): HCkTask; stdcall;

function CkZip_ExtractMatching(objHandle: HCkZip; dirPath: PWideChar; pattern: PWideChar): wordbool; stdcall;

function CkZip_ExtractMatchingAsync(objHandle: HCkZip; dirPath: PWideChar; pattern: PWideChar): HCkTask; stdcall;

function CkZip_ExtractNewer(objHandle: HCkZip; dirPath: PWideChar): wordbool; stdcall;

function CkZip_ExtractNewerAsync(objHandle: HCkZip; dirPath: PWideChar): HCkTask; stdcall;

function CkZip_ExtractOne(objHandle: HCkZip; entry: HCkZipEntry; dirPath: PWideChar): wordbool; stdcall;

function CkZip_ExtractOneAsync(objHandle: HCkZip; entry: HCkZipEntry; dirPath: PWideChar): HCkTask; stdcall;
...
function CkZip_WriteExeAsync(objHandle: HCkZip; exeFilename: PWideChar): HCkTask; stdcall;
...
function CkZip_WriteExe2Async(objHandle: HCkZip; exePath: PWideChar; destExePath: PWideChar; bAesEncrypt: wordbool; keyLength: Integer; password: PWideChar): HCkTask; stdcall;
...
function CkZip_ExtractIntoAsync; external DLLName;
function CkZip_ExtractMatching; external DLLName;
function CkZip_ExtractMatchingAsync; external DLLName;
function CkZip_ExtractNewer; external DLLName;
function CkZip_ExtractNewerAsync; external DLLName;
function CkZip_ExtractOne; external DLLName;
function CkZip_ExtractOneAsync; external DLLName;
...
function CkZip_WriteExeAsync; external DLLName;
function CkZip_WriteExe2; external DLLName;
function CkZip_WriteExe2Async; external DLLName;
function CkZip_WriteExeToMemory; external DLLName;
function CkZip_WriteExeToMemoryAsync; external DLLName;
